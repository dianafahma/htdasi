<?php 
	...
	function proses_trx($jtotal){
		...
		$query=$this->db->query("INSERT INTO pemesanan (id_pemesanan, nama,hp,email, alamat,total) VALUES ('$vid','$vnama_pemesan','$vhp','$vemail','$vala','$jtotal')");	
	}
