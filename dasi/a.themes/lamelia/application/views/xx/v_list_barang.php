...
<table><tr><td><?php echo form_open('c_sembako/cari_barang/'); 
...
<br/>
	...
	<tr><?php foreach ($list_barang as $row)
	...
	<tr>
		...
		<td><?php echo anchor ('c_sembako/tampil_detail_barang','Detail'); ?> | 
		<?php echo anchor ('c_sembako/ubah_barang/'.$row['kode_barang'],'Ganti')?> | 
		<?php echo anchor ('c_sembako/hapus_barang/'.$row['kode_barang'],'Hapus')?>
		</td>
	<tr>
<?php  } ?>
	</table>
