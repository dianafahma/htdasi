	...
	<div class="container">
		<div class="header_top">
			<div class="top_right">
				<ul>
					<li><a href="#">help</a></li>|
					<li><a href="<?php echo ('index.php/shop_control/contact')?>">Contact</a></li>|
...
<div class="container">
	...
	<div class="head-t">
		<div class="logo">
			<a href="<?php echo ('index.php')?>"><img src="<?php echo ('asset/images/logo.png')?>" class="img-responsive" alt=""/> </a>
		</div>
		<!-- start header_right -->
		<div class="header_right">
			<div class="rgt-bottom">
				...
				<div class="reg">
					<a href="<?php echo ('index.php/shop_control/register.php')?>">REGISTER</a>
				</div>
			<div class="cart box_1">
				<a href="checkout.html">
					<h3> <span class="simpleCart_total">$0.00</span> (<span id="simpleCart_quantity" class="simpleCart_quantity">0</span> items)<img src="<?php echo ('asset/images/bag.png')?>" alt=""></h3>
				</a>	
				<p><a href="<?php echo ('asset/javascript:;')?>" class="simpleCart_empty">(empty card)</a></p>
				<div class="clearfix"> </div>
			</div>
	...
	<div class="container">
		<div class="arriv-top">
			<div class="col-md-6 arriv-left">
				<img src="<?php echo ('asset/images/1.jpg')?>" class="img-responsive" alt="">
			...
			<div class="col-md-6 arriv-right">
				<img src="<?php echo ('asset/images/2.jpg')?>" class="img-responsive" alt="">
				<div class="arriv-info">
					<h3>TUXEDO</h3>
					<p>REVIVE YOUR WARDROBE WITH CHIC KNITS</p>
					<div class="crt-btn">
		...
		<div class="arriv-bottm">
			<div class="col-md-8 arriv-left1">
				<img src="<?php echo ('asset/images/3.jpg')?>" class="img-responsive" alt="">
			...
			<div class="col-md-4 arriv-right1">
				<img src="<?php echo ('asset/images/4.jpg')?>" class="img-responsive" alt="">
		...
		<div class="arriv-las">
			<div class="col-md-4 arriv-left2">
				<img src="<?php echo ('asset/images/5.jpg')?>" class="img-responsive" alt="">
				<div class="arriv-info2">
					<a href="details.html"><h3>Casual Glasses<i class="ars"></i></h3></a>
				</div>
			</div>
			<div class="col-md-4 arriv-middle">
				<img src="<?php echo ('asset/images/6.jpg')?>" class="img-responsive" alt="">
			...
			<div class="col-md-4 arriv-right2">
				<img src="<?php echo ('asset/images/7.jpg')?>" class="img-responsive" alt="">
				<div class="arriv-info2">
...
<div class="special">
	<div class="container">
		...
		<div class="specia-top">
			<ul class="grid_2">
		<li>
				<a href="details.html"><img src="<?php echo ('asset/images/8.jpg')?>" class="img-responsive" alt=""></a>
		...
		<li>
				<a href="details.html"><img src="<?php echo ('asset/images/9.jpg')?>" class="img-responsive" alt=""></a>
				<div class="special-info grid_1 simpleCart_shelfItem">
		...
		<li>
				<a href="details.html"><img src="<?php echo ('asset/images/10.jpg')?>" class="img-responsive" alt=""></a>
				<div class="special-info grid_1 simpleCart_shelfItem">
		...
		<li>
				<a href="details.html"><img src="<?php echo ('asset/images/11.jpg')?>" class="img-responsive" alt=""></a>
				<div class="special-info grid_1 simpleCart_shelfItem">
