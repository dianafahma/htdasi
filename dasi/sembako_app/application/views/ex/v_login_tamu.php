		...
		<tr>
			<td> 
				<div class="nav">
					...
					<ul>
						<li ><?php echo anchor ('c_tsembako/display_home','Beranda'); ?></li>
						<li> <?php echo anchor ('c_tsembako/display_barang','Gudang Sembako'); ?></li>
						<li><?php echo anchor ('c_tsembako/display_toko','Pemasok')?></li>
						<li> <?php echo anchor ('c_tsembako/display_tentang','Tentang Kita')?></li>
						<li> <?php echo anchor ('c_tsembako/display_kontak','Kontak')?></li>
					</ul>
