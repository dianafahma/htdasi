...
<body>
	...
	<div class="body">
		<div>
			<div class="featured">
				<img src="<?php echo base_url().'asset/images/camping.jpg'?>" alt="">
				<div>
					<div>
						...
						<a href="<?php echo base_url().'index.php/c_camp/view_register'?>">REGISTER NOW!</a>
					</div>
				</div>
			</div>
			<div>
				<div>
					<div>
						...
						<div>
							...
							<a href="<?php echo base_url().'index.php/c_camp/view_events'?>">View All</a>
						</div>
					</div>
				</div>
			</div>
