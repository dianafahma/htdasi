	...
	<div class="container">
		<div class="header_top">
			<div class="top_right">
				<ul>
					<li><a href="#">help</a></li>|
					<li><a href="<?php echo base_url('index.php/shop_control/contact')?>">Contact</a></li>|
...
<div class="container">
	...
	<div class="head-t">
		<div class="logo">
			<a href="<?php echo ('index.php')?>"><img src="<?php echo base_url('asset/images/logo.png')?>" class="img-responsive" alt=""/> </a>
		</div>
		<!-- start header_right -->
		<div class="header_right">
			<div class="rgt-bottom">
				...
				<div class="reg">
					<a href="<?php echo base_url('index.php/shop_control/register')?>">REGISTER</a>
				</div>
			<div class="cart box_1">
				<a href="<?php echo base_url('index.php/shop_control/checkout')?>">
					<h3> <span class="simpleCart_total">$0.00</span> (<span id="simpleCart_quantity" class="simpleCart_quantity">0</span> items)<img src="<?php echo base_url('asset/images/bag.png')?>" alt=""></h3>
				</a>	
				<p><a href="<?php echo base_url('asset/javascript:;')?>" class="simpleCart_empty">(empty card)</a></p>
				<div class="clearfix"> </div>
			</div>
			<div class="create_btn">
				<a href="<?php echo base_url('index.php/shop_control/checkout.php')?>">CHECKOUT</a>
			</div>
			<div class="clearfix"> </div>
		</div>
		<div class="search">
		...
		<ul class="megamenu skyblue">
			<li class="active grid"><a class="color1" href="<?php echo base_url('index.php/')?>">Home</a></li>
						...
						<div class="col1">
							<div class="h_nav">
								...
								<ul>
									...
									<li><a href="<?php echo ('index.php/shop_control/register')?>">create an account</a></li>
