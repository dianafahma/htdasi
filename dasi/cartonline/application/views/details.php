			...
			<div class="row single">
				<div class="col-md-9 det">
				  <div class="single_left">
					<div class="grid images_3_of_2">
						<div class="flexslider">
							        <!-- FlexSlider -->
										<script src="<?php echo base_url('asset/js/imagezoom.js')?>"></script>
							  ...
							  <ul class="slides">
								<li data-thumb="<?php echo base_url('asset/images/d1.jpg')?>">
									<div class="thumb-image"> <img src="<?php echo base_url('asset/images/d1.jpg')?>" data-imagezoom="true" class="img-responsive"> </div>
								</li>
								<li data-thumb="<?php echo base_url('asset/images/d2.jpg')?>">
									 <div class="thumb-image"> <img src="<?php echo base_url('asset/images/d2.jpg')?>" data-imagezoom="true" class="img-responsive"> </div>
								</li>
								<li data-thumb="<?php echo base_url('asset/images/d3.jpg')?>">
								   <div class="thumb-image"> <img src="<?php echo base_url('asset/images/d3.jpg')?>" data-imagezoom="true" class="img-responsive"> </div>
								</li>
								<li data-thumb="<?php echo base_url('asset/images/d4.jpg')?>">
								   <div class="thumb-image"> <img src="<?php echo base_url('asset/images/d4.jpg')?>" data-imagezoom="true" class="img-responsive"> </div>
								</li>
							  </ul>
				  ...
				  <div class="desc1 span_3_of_2">
					...
					<div class="btn_form">
						<a href="<?php echo base_url('index.php/shop_control/checkout')?>">buy</a>
					</div>
				...
				<div class="single-bottom2">
					<h6>Related Products</h6>
						<div class="product">
						   <div class="product-desc">
								<div class="product-img">
		                           <img src="<?php echo base_url('asset/images/w8.jpg')?>" class="img-responsive " alt=""/>
		                       </div>
				     ...
				     <div class="product">
						   <div class="product-desc">
								<div class="product-img">
		                           <img src="<?php echo base_url('asset/images/w10.jpg')?>" class="img-responsive " alt=""/>
		                       </div>
		                       <div class="prod1-desc">
		                           <h5><a class="product_link" href="#">Excepteur sint</a></h5>
		                           <p class="product_descr"> Vivamus ante lorem, eleifend nec interdum non, ullamcorper et arcu. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. </p>									
