<div align="center">
<title>Update Nama Profil</title>
<h3> UPDATE NAMA PROFIL</h3><br>
</div>
<?php echo form_open('c_reporter/update_nama/'.$row_data->username.''); ?>
...
<td> </td><td> </td><br>
	...
	<?php echo anchor ('c_reporter/update_nama/'.$row_data->username, '<button type="submit" class="btn btn-sm btn-success">Simpan Perubahan</button>'); ?></td>
</tr>
<tr>
	<td colspan="3">&nbsp;</td>
</tr>
