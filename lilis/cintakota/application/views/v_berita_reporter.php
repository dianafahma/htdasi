...
<div class="btn-group">
		<?php echo anchor('c_berita/display1','<b class="btn btn-twitter btn-lg"><i class="icon-twitter icon-large"></i>Semua Berita</b>')?> 
		<?php echo anchor('c_berita/terpublis','<b class="btn btn-facebook btn-lg"><i class="icon-facebook icon-large"></i>Telah Dipublis</b>')?> 
		<?php echo anchor('c_berita/arsip','<b class="btn btn-google-plus btn-lg"><i class="icon-google-plus icon-large"></i> Arsip Perusahaan</b>')?> 
		</div>
	  <p><p><p><p>
<?php
$i=1;
