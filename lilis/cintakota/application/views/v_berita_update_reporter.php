...
<fieldset>
	...
	<p>
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="text" name="id" style="width:500" class="form-control" disabled="disabled" value="<?php echo $list_berita->id?>">
	</p>
	<p>
		<label bgcolor="red" style="padding-left:10" value="<?php echo $list_berita->kgr_judul?>"> Kategori </label>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<select type="text" name="kgr_judul" style="width:500" class="form-control">
	...
	<p>
		...
		&nbsp;&nbsp;&nbsp;
		<input type="text" name="judul" style="width:500" class="form-control" value="<?php echo $list_berita->judul?>">
	</p>
	<p>
	...
	<tr align="center">
		...
		<div align="center">
			<?php echo form_submit('submit','Update','id="submit"'); ?>
			<?echo form_close();?>&nbsp;
			<?php echo anchor('c_berita/display2','<button>Batal</button>')?>
		</div><br>
	</tr>
</fieldset>
</tr>
