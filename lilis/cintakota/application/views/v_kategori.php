...
<div class="btn-group">
		<?php echo anchor('c_berita/k_hiburan','<b class="btn btn-twitter btn-lg"><i class="icon-twitter icon-large"></i>HIBURAN</b>')?> 
		<?php echo anchor('c_berita/k_politik','<b class="btn btn-facebook btn-lg"><i class="icon-facebook icon-large"></i>POLITIK</b>')?> 
		<?php echo anchor('c_berita/k_kriminal','<b class="btn btn-google-plus btn-lg"><i class="icon-google-plus icon-large"></i>KRIMINAL</b>')?> 
		<?php echo anchor('c_berita/k_teknologi','<b class="btn btn-twitter btn-lg"><i class="icon-twitter icon-large"></i>TEKNOLOGI</b>')?> 
		<?php echo anchor('c_berita/k_bisnis','<b class="btn btn-facebook btn-lg"><i class="icon-facebook icon-large"></i>BISNIS</b>')?> 
		<?php echo anchor('c_berita/k_inter','<b class="btn btn-google-plus btn-lg"><i class="icon-google-plus icon-large"></i>INTERNASIONAL</b>')?> 
		</div>
	  <p><p><p><p>
<?php
$i=1;
...
?>	
	<div class="reporter">
		...
		<img src="<?php echo base_url().$foto ; ?>" width="200" height="200">
		<br><br>
