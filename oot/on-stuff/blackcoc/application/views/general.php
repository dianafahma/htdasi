...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Admin | Souvenir General</title>
                                ...
                                <li>
                                    ...
                                    <ul class="menu">
                                        <li><!-- start message -->
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="<?php echo base_url().'media/img/avatar3.png'?>" class="img-circle" alt="User Image"/>
                                                </div>
                                                <h4>
                                                    Support Team
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="<?php echo base_url().'media/img/avatar2.png'?>" class="img-circle" alt="user image"/>
                                                </div>
                                                <h4>
                        ...
                        <section class="panel general">
                                ...
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="active">
                                        <a data-toggle="tab" href="#about-2">
                                            <i class="fa fa-user"></i>
                                             About <!--about ini untuk yang ada di tab-->
                                        </a>
                                    </li>
                                    <li class="">
                            ...
                            <div class="panel-body">
                                <div class="tab-content">
                                    ...
                                    <div id="about-2" class="tab-pane active">Ini isi halaman About</div>
                                    <div id="contact-2" class="tab-pane ">Ini berisi Kontak yang tampil di link harus di isi kotak yang redirect ke halaman utama</div>
                                </div>
                            </div>
                        </section>
                        <!--tab nav end-->
