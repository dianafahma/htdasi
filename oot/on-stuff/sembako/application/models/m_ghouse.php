<?php
class M_ghouse extends CI_Model{
	...
	function get_list_unggah(){
		...
		//$tanggal=date('Y-m-d');
		//$n='uploads/'.$namafile;
		$query=$this->db->query("INSERT INTO room(kode,tipe,rate,image,avail,facility) VALUES ('$kode','$deskripsi','$rate','$namafile','$avail','$facility')");
	}
